...
const code = buildSync({
  stdin: {
    contents: `export * from './lib/i18n'; export * from './app/language'; export * from './app/ui'; export * from './app/views'; export * from './app/finance-work'; export {default as Welcome} from './app/welcome';`,
